...
OFFERS = [
    {
        ...
        "ask": "I write a full Finnish article for every Desk A category that has raw (talous, politiikka, urheilu, "
        "kulttuuri, tiede, terveys, …) from the day's scraped material. Runs on the evening schedule — ask "
        "only for a re-run. I write from the raw; I don't fetch sources or build the front page.",
        ...
        "sample": "## Desk A — talous (2026-06-16)\n"
        "\n"
        "**Korot pysyvät ennallaan — mitä se tarkoittaa lainanottajalle**\n"
        "\n"
        "Suomen Pankin mukaan… *(täysi suomenkielinen artikkeli per kategoria: politiikka, urheilu, "
        "kulttuuri, tiede, terveys).*\n"
        "\n"
