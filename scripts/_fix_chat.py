...
html = requests.get(
    f"{base}/v1/apps/happydude500001/live-chat-room.html?mode=download",
...
print(
    byname["publish_app"].run(
        filename="live-chat-room.html",
        html=html,
        name="Live Chat Room",
        description="Real-time multiplayer chat (event-name fix)",
