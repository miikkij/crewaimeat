...
_M = {
    "fi": {
        ...
        "scope": "hyväksytty ilman oikeuksia {s} — liitä uudelleen ja valitse ne hyväksyntäsivulla",
    ...
    "en": {
        ...
        "scope": "approved without {s} — reconnect and tick them on the approval page",
